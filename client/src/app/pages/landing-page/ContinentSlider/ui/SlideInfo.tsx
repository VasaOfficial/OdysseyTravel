    ...
    <>
      ...
      <motion.div layout className="mt-5 flex items-center gap-3">
        <Link
          ...
          className="mt-3 w-fit rounded-full border-[1px] border-[#ffffff8f] px-6 py-3 text-lg font-extralight transition duration-300 ease-in-out hover:bg-white hover:text-black"
        >
          DISCOVER LOCATION
        </Link>
      </motion.div>
