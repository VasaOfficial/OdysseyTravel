    ...
    <section className="relative h-screen w-full">
      <div className="relative h-full w-full">
        ...
        <div className="absolute left-0 top-0 m-16 p-4 text-white">
          ...
          <h1 className="mb-12 text-6xl font-extrabold">Log in</h1>
          <div className="flex w-[450px] flex-col gap-2 rounded-2xl bg-white p-7">
            <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
              ...
              {incorrectCredentials && <p className="mb-2 text-red-500">{incorrectCredentials}</p>}
              <div className="font-semibold text-slate-700">
              ...
              <span
                className="ml-1 cursor-pointer text-sm font-medium text-sky-600"
                onClick={() => setShowForgotPasswordModal(true)}
              >
                Forgot password?
              </span>
              <div className="mb-5 mt-8 flex w-full items-center justify-center">
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                <div className="rounded-lg bg-white p-6 shadow-lg">
                  ...
                  <input
                    ...
                    className="mb-4 h-12 w-full rounded-lg border border-gray-300 px-4 text-black"
                  />
                  <button
                    onClick={handleForgotPasswordSubmit}
                    className="blue-btn w-full text-center"
                  >
                    Submit
                  </button>
                  <button
