    ...
    <section className="relative h-screen w-full">
      <div className="relative h-full w-full">
        ...
        <div className="absolute top-0 left-0 text-white p-4 m-16">
          ...
          <h1 className="mb-1 font-extrabold text-6xl">Create new account</h1>
          <div className="flex gap-2">
            <p>Already a member?</p>
            <Link className="text-sky-600" href='/sign-in'>Log in</Link>
          </div>
          <div className='flex flex-col max-w-md'>
            <div className="flex gap-5 my-5 w-full text-center">
              ...
              <div className='flex mb-5 gap-5'>
                <div>
                  <input
                    ...
                    className="text-black w-full p-4 rounded-lg mb-1"
                  />
                ...
                <div>
                  <input
                    ...
                    className="text-black w-full rounded-lg mb-1 p-4"
                  />
